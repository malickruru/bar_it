  ...
  return (
    ...
    <div className='container'>
        <div className='row py-3'>
            <Title title={'Nos projets récents'} subTitle='Ils nous ont fait confiance 😄'/>
        </div>  
    </div>
    <div className='container'>
        <div className='row py-3'>
        <Slider {...settings} >
            <div className='ProjectCard' data-aos='zoom-in' data-aos-offset = '100'>
            ...
            <div className='ProjectCard' data-aos='zoom-in' data-aos-offset = '150'>
            ...
            <div className='ProjectCard' data-aos='zoom-in' data-aos-offset = '200'>
